<?php
$nav_items = [
    'Home' => '', 'For Freelancers' => '/freelancers', 'For Employers' => '/employers'
]
?>

<nav id="primary-nav" class="sticky top-0 z-50 py-2 shadow">
    <div class="p-2 mx-auto flex flex-wrap items-center justify-between">
        <a href="{{ url('') }}" class="flex">
            <img style="width: 230px;" src="{{ url('logo.png') }}" alt="{{ \SiteInfo::name() }} logo">
        </a>
        ...
        <div class="hidden md:block w-full md:w-auto" id="mobile-menu">
            <ul class="flex-col md:flex-row flex md:space-x-2 mt-4 md:mt-0 md:text-sm md:font-medium">
                ...
                <li class="mt-2 md:m-auto">
                    ...
                    <a class="btn btn-get-started" href="{{ route('register') }}">Get Started</a>
                    @else
