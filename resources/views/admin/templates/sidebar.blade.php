<?php 
$sidebar_items = ['Posts' => 'admin/posts', 'Pages' => 'admin/pages', 'Categories' => 'admin/categories', 'Users' => 'admin/users', 'Media' => 'admin/media', 'Settings' => 'admin/settings']
?>
    ...
    <div class="flex flex-col overflow-x-hidden h-screen py-2 px-1 justify-between">
        ...
        <div class="flex flex-col flex-auto">
            ...
            <div class="">
                ...
                <a class="block w-full font-bold text-base text-gray-500 hover:text-gray-300 border-l-2 border-gray-800 hover:border-blue-400 p-1 link" href="{{ url($uri) }}">{{ $label }}</a>
                </div>
            </div>
            @endforeach
        </div>
